...
CImdViewerView::CImdViewerView() : _capture_mouvement(false), _position(0.0f, 0.0f, -2.0f),
                                   ...
                                   _object(0), _d3d_backbuffer(0), _d3d_depthbuffer(0), _d3d_object(0), _current_anim(0), _bone(0), _use_bone_for_animation(false)
{
...
void CImdViewerView::CreateGrid(int size, float increment)
{
  ...
  for (float x = -middle; x < middle; ++x)
  {
    ...
    {
      v->_color = 0xffffffff;
      v->_pos = D3DXVECTOR3((x * increment) - inc_middle, 0.0f, (y * increment) - inc_middle);
      v++;
      v->_color = 0xffffffff;
      v->_pos = D3DXVECTOR3((x * increment) - inc_middle, 0.0f, (y * increment) + inc_middle);
      v++;
  ...
  v->_color = 0xffff0000;
  v->_pos = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
  v++;
  v->_color = 0xffff0000;
  v->_pos = D3DXVECTOR3(increment, 0.0f, 0.0f);
  v++;
  v->_color = 0xff00ff00;
  v->_pos = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
  v++;
  v->_color = 0xff00ff00;
  v->_pos = D3DXVECTOR3(0.0f, increment, 0.0f);
  v++;
  v->_color = 0xff0000ff;
  v->_pos = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
  v++;
  v->_color = 0xff0000ff;
  v->_pos = D3DXVECTOR3(0.0f, 0.0f, increment);
  v++;
