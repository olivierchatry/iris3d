...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	if (!m_wndAnimBar.Create(this, CDialogBarAnim::IDD, CBRS_TOP | CBRS_GRIPPER 
		| CBRS_FLYBY, CDialogBarAnim::IDD))
	{
		TRACE0("Failed to create dialogbar\n");
		return -1;      // fail to create
	}
	...
	if (!m_wndBonesToolBar.Create(this, CDialogBarBoneList::IDD	, 
		...
		| CBRS_FLYBY, CDialogBarBoneList::IDD))
	{
		TRACE0("Failed to create dialogbar\n");
		return -1;      // fail to create
	}
	if (!m_wndBoneTreeToolBar.Create(this, CDialogBarBoneTree::IDD	, 
		CBRS_TOP | CBRS_GRIPPER 
		| CBRS_FLYBY, CDialogBarBoneTree::IDD))
	{
		TRACE0("Failed to create dialogbar\n");
		return -1;      // fail to create
	}
	...
	if (!m_wndMeshInfoToolBar.Create(this, CDialogBarMeshInfo::IDD	, 
		CBRS_TOP | CBRS_GRIPPER 
		| CBRS_FLYBY, CDialogBarMeshInfo::IDD))
	{
		TRACE0("Failed to create dialogbar\n");
		return -1;      // fail to create
	}
