...
public:
	...
	\param Number of vertex to allocate.
	\param Number of animation frame.
	\return Nothing.
	*/
	void	Allocate(int num_vertex, int num_anim);
	//! Destroy
	/*!
	...
	*/
	...
	\param Index of the vertice in the buffer.
	\return The vertice.
	*/
	...
	\param Index of the vertice in the buffer. The transformation
	use IrisCamera, World and Object matrix.
	...
	*/
	...
	\param Index of the normal in the buffer.
	\return The normal.
	*/
    vect3d					*GetNormal(int i){return &_normal[i];}
	//! GetTransformedNormal
	/*!
	Return a 3d transformed normal. We just use
	Rotation component of the concatenation matrix between
	World and Object matrix.
	...
	*/
	...
	/param Radius of the bounding sphere.
	/return nothing.
	*/
	...
	*/
	...
	\param Indice in the color buffer
	\paran IrisColor value to be placed in the color buffer.
	\return Nothing.
	*/
	...
	*/
	...
	\param Offset in the color buffer.
...
public:
	...
	*/
	...
	/*!
		...
		\param Define wich position on the animation you want. 
	...
	*/
	...
	\param Define the number of animation that the tag will
	contain.
	\return Nothing.
	*/
...
public:
	...
	*/
	...
	\param Define path where it can find the file and material data (aka texture)
	\param Define file name of the imd file.
	\param Define scale value to be applyed when loading the object.
	\note Normally you do not call directly this method and let the class IrisObject do it for you.
	...
	*/
	...
	\param Index of the mesh in the object.
	...
	*/
	...
	just a texture.
	\param Index of the material in the object.
	...
	*/
	...
	\param Index of the tag in the object.
