...
private:
	static void CommitLerp(volatile pvr_vertex_t *vert, const vect3d& v3dpos, const vect3d& v3dneg,
					const vertex2dtl& vpos, const vertex2dtl& vneg,	bool end = false);
